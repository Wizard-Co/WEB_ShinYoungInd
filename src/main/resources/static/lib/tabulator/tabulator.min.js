...
!function (e, t) {
    ...
    class u extends t {
        ...
        generateColumnsFromRowData(e) {
            var t = [], i = {}, s = "full" === this.table.options.autoColumns ? e : [e[0]],
        ...
        _addColumn(e, t, i) {
            var s = new r(e, this), o = s.getElement(), n = i ? this.findColumnIndex(i) : i;
    ...
    class b extends h {
        ...
        _virtualRenderFill(e, t, i) {
            var s, o, n = this.tableElement, r = this.elementVertical, l = 0, h = 0, d = 0, c = 0, u = 0, m = 0,
                p = this.rows(), g = p.length, b = 0, f = [], v = 0, w = 0, C = this.table.rowManager.fixedHeight,
    ...
    class w extends t {
        ...
        bindComponents(e, t) {
            ...
            for (let e of i) {
                let i, n = t[e], a = this.previousTargets[e];
                if (a && a.target === n) i = a.component; else switch (e) {
                    case"row":
                    case"group":
                        if (s.components.includes("row") || s.components.includes("cell") || s.components.includes("group")) {
                            i = this.table.rowManager.getVisibleRows(!0).find((e => e.getElement() === n)), t.row && t.row.parentNode && t.row.parentNode.closest(".tabulator-row") && (t[e] = !1)
                        }
                        break;
                    case"column":
                        ...
                        break;
                    case"cell":
                        s.components.includes("cell") && (o.row instanceof p ? i = o.row.findCell(n) : t.row && console.warn("Event Target Lookup Error - The row this cell is attached to cannot be found, has the table been reinitialized without being destroyed first?"))
                }
                i && (o[e] = i, r[e] = {target: n, component: i})
            }
            return this.previousTargets = r, Object.keys(t).forEach((e => {
                let t = o[e];
                n[e] = t
            })), n
        }
    ...
    let k = class e extends t {
        ...
        _fitToScreen(e, t, i, s, o) {
            ...
            if (t + this.element.offsetHeight > r) if (i) if ("bottom" === o) this.element.style.top = parseInt(this.element.style.top) - this.element.offsetHeight - i.offsetHeight - 1 + "px"; else this.element.style.top = parseInt(this.element.style.top) - this.element.offsetHeight + i.offsetHeight + 1 + "px"; else this.element.style.height = r + "px"
        }
    ...
    var S = {
        fitData: function (e, t) {
        ...
        }, fitDataFill: L, fitDataTable: L, fitDataStretch: function (e, t) {
            ...
            function m(e, t, i, s) {
                var o = [], n = 0, r = 0, l = 0, h = a, d = 0, c = 0, p = [];
    ...
    var F = Object.freeze({
        __proto__: null, CommsModule: class extends M {
        ...
        }, LayoutModule: D, LocalizeModule: P
    });
    ...
    class H {
        static registry = {
            tables: [], register(e) {
                ...
                } else "undefined" != typeof HTMLElement && e instanceof HTMLElement || e instanceof H ? (s = H.registry.matchElement(e)) && o.push(s) : Array.isArray(e) ? e.forEach((function (e) {
    ...
    class _ extends H {
        ...
        static _extendModule(e, t, i) {
            if (_.moduleBindings[e]) {
                ...
                if (s) if ("object" == typeof i) for (let e in i) s[e] = i[e]; else console.warn("Module Error - Invalid value type, it must be an object"); else console.warn("Module Error - property does not exist:", t)
        ...
        _bindModules() {
            ...
            for (var s in this.modules = {}, _.moduleBindings) {
                let o = _.moduleBindings[s], n = new o(this);
    ...
    class X extends M {
        ...
        constructor(e) {
            ...
            })), this.registerTableOption("ajaxResponse", !1), this.contentTypeFormatters = X.contentTypeFormatters
        }
    ...
    class ee extends M {
        ...
        rowsToData(e) {
            var t = [], i = this.table.options.dataTree && this.table.options.dataTreeChildColumnCalcs,
    ...
    var te = {
        csv: function (e, t = {}, i) {
            ...
            var o = i.sheetName || "Sheet1", n = this.dependencyRegistry.lookup("XLSX"), r = n.utils.book_new(),
                a = new t(this), l = !("compress" in i) || i.compress,
                h = i.writeOptions || {bookType: "xlsx", bookSST: !0, compression: l};

            function d() {
                var t = [], i = [], s = {}, o = {
                    s: {c: 0, r: 0},
                    e: {c: e[0] ? e[0].columns.reduce(((e, t) => e + (t && t.width ? t.width : 1)), 0) : 0, r: e.length}
                };
    ...
    var ne = {
        input: function (e, t, i, s, o) {
            ...
            var n, r = o.format, a = o.verticalNavigation || "editor",
            ...
            var n, r, a = e._getSelf().column;
            return n = o.editorLookup ? o.editorLookup(e) : function (e) {
                var t = e.getValue(), i = "input";
                switch (typeof t) {
                    case"number":
                        i = "number";
                        break;
    ...
    class ce extends M {
        ...
        generateTableElement(e) {
            var t = document.createElement("table"), i = document.createElement("thead"),
                ...
                n = this.table.options["rowFormatter" + this.colVisPropAttach], r = {};
        ...
        generateRowElement(e, t, i) {
            ...
            if (s.classList.add("tabulator-print-table-row"), e.columns.forEach(((o, n) => {
                if (o) {
                    var r, a, l = document.createElement("td"), h = o.component._column, d = this.table,
                        c = d.columnManager.findColumnIndex(h), u = o.value, m = {
        ...
        generateHeaderFilterElement(e, t, i) {
            ...
            if (e.modules.filter.value = t, e.modules.filter.headerElement && e.modules.filter.headerElement.parentNode && e.contentElement.removeChild(e.modules.filter.headerElement.parentNode), m) {
                ...
                if (o) {
                    ...
                    }), h))) return void console.warn("Filter Error - Cannot add filter to " + m + " column, editor returned a value of false");
    ...
    var pe = {
        plaintext: function (e, t, i) {
            ...
            var s, o, n, r, a, l = parseFloat(e.getValue()), h = "", d = t.decimal || ".", c = t.thousand || ",",
                u = t.negativeSign || "-", m = t.symbol || "", p = !!t.symbolAfter,
            ...
            var s, o = this.table.dependencyRegistry.lookup(["luxon", "DateTime"], "DateTime"),
                n = t.inputFormat || "yyyy-MM-dd HH:mm:ss", r = t.outputFormat || "dd/MM/yyyy HH:mm:ss",
            ...
            var s = e.getValue(), o = e.getElement(), n = t && t.stars ? t.stars : 5,
                r = document.createElement("span"), a = document.createElementNS("http://www.w3.org/2000/svg", "svg");
            ...
            var s, n, r, a, l, h = this.sanitizeHTML(e.getValue()) || 0, d = e.getElement(), c = t.max ? t.max : 100,
                u = t.min ? t.min : 0, m = t.legendAlign ? t.legendAlign : "center";
            ...
            var s, o, n = e.getValue(), r = t.size || 15, a = r + "px", l = !t.hasOwnProperty("onValue") || t.onValue,
                h = !!t.hasOwnProperty("offValue") && t.offValue, d = t.onTruthy ? n : n === l;
            ...
            var s, o = t.delimiter || ",", n = e.getValue(), r = this.table;
            ...
            var s = t.indent || "\t", o = void 0 === t.multiline || t.multiline, n = t.replacer || null,
                r = e.getValue();
    ...
    var ye = {
        csv: function (e) {
            ...
            var t = this.dependencyRegistry.lookup("XLSX"), i = t.read(e), s = i.Sheets[i.SheetNames[0]];
        ...
        pickFile(e, t) {
            return new Promise(((i, s) => {
                ...
                o.type = "file", o.accept = e, o.addEventListener("change", (e => {
                    var n = o.files[0], r = new FileReader, a = this.validateFile(n);
                    if (!0 === a) {
    ...
    class Se extends M {
        ...
        setStartPosition(e, t) {
            var i, s, o = this.touchMove ? e.touches[0].pageX : e.pageX,
    ...
    var Pe = {
        rows: function (e, t, i, s, o) {
            var n = document.createElement("span"), r = document.createElement("span"),
                a = document.createElement("span"), l = document.createElement("span"),
                h = document.createElement("span"), d = document.createElement("span");
    ...
    class Ie extends t {
        ...
        layout() {
            var e, t, i, s, o, n, r, a, l, h, d = this.table.rowManager.renderer.vDomTop,
                c = this.table.rowManager.renderer.vDomBottom, u = this.table.columnManager.renderer.leftCol,
        ...
        getBounds(e) {
            var t = this.getCells(!1, e), i = {start: null, end: null};
    ...
    function We(e, t, i, s, o, n, r) {
        var a = this.table.dependencyRegistry.lookup(["luxon", "DateTime"], "DateTime"),
            l = r.format || "dd/MM/yyyy HH:mm:ss", h = r.alignEmptyValues, d = 0;
        if (void 0 !== a) {
    ...
    var je = {
        ...
        }, datetime: We, boolean: function (e, t, i, s, o, n, r) {
            return (!0 === e || "true" === e || "True" === e || 1 === e ? 1 : 0) - (!0 === t || "true" === t || "True" === t || 1 === t ? 1 : 0)
        }, array: function (e, t, i, s, o, n, r) {
            var l, h = r.type || "length", d = r.alignEmptyValues, c = 0, u = this.table;
    ...
    class Ge extends M {
        ...
        sort(e, t) {
            var i = this, s = this.table.options.sortOrderReverse ? i.sortList.slice().reverse() : i.sortList, o = [],
                n = [];
    ...
    var Ye = Object.freeze({
        ...
        DataTreeModule: class extends M {
            ...
            initializeRow(e) {
                var t = e.getData()[this.field], i = Array.isArray(t),
        ...
        GroupRowsModule: class extends M {
            ...
            rowMoving(e, t, i) {
                if (this.table.options.groupBy) {
                    ...
                    var s = t instanceof fe ? t : t.modules.group, o = e instanceof fe ? e : e.modules.group;
        ...
        ResizeColumnsModule: class extends M {
            ...
            resize(e, t) {
                var i, s, o = void 0 === e.clientX ? e.touches[0].clientX : e.clientX, n = o - this.startX,
                    r = o - this.latestX;
            ...
            calcGuidePosition(e, t, i) {
                var s = void 0 === e.clientX ? e.touches[0].clientX : e.clientX,
                    ...
                    n = this.table.element.getBoundingClientRect().x, r = t.element.getBoundingClientRect().left - n,
                    a = s - this.startX, l = Math.max(o + a, r + t.minWidth);
        ...
        ResizeRowsModule: class extends M {
            ...
            calcGuidePosition(e, t, i) {
                var s = void 0 === e.screenY ? e.touches[0].screenY : e.screenY,
                    ...
                    n = this.table.element.getBoundingClientRect().y, r = t.element.getBoundingClientRect().top - n,
                    a = s - this.startY;
            ...
            _mouseDown(e, t, i) {
                ...
                }))), o.table.element.classList.add("tabulator-block-select"), e.stopPropagation(), o.startY = void 0 === e.screenY ? e.touches[0].screenY : e.screenY, o.startHeight = t.getHeight(), document.body.addEventListener("mousemove", n), document.body.addEventListener("mouseup", r), i.addEventListener("touchmove", n, {passive: !0}), i.addEventListener("touchend", r)
            }
        },
        ...
        ResponsiveLayoutModule: class extends M {
            ...
            formatCollapsedData(e) {
                ...
                return e.forEach((e => {
                    var i, s = document.createElement("tr"), o = document.createElement("td"),
                        n = document.createElement("td"), r = document.createElement("strong");
        ...
        SelectRangeModule: class extends M {
            ...
            renderCell(e) {
                var t = e.getElement(), i = this.ranges.findIndex((t => t.occupies(e)));
            ...
            findJumpCellLeft(e, t) {
                var i = this.getRowByRangePos(e), s = this.getTableColumns(),
                    o = this.isEmpty(i.getData()[s[t].getField()]),
                    n = !!s[t - 1] && this.isEmpty(i.getData()[s[t - 1].getField()]),
                    r = this.rowHeader ? s.slice(1, t) : s.slice(0, t), a = this.findJumpCol(i, r, !0, o, n);
            ...
            findJumpCellUp(e, t) {
                var i = this.getColumnByRangePos(t), s = this.getTableRows(),
            ...
            autoScroll(e, t, i) {
                var s, o, n, r = this.table.rowManager.element;
            ...
            layoutRow(e) {
                var t = e.getElement(), i = !1, s = this.ranges.some((t => t.occupiesRow(e)));
            ...
            layoutColumn(e) {
                var t = e.getElement(), i = !1, s = this.ranges.some((t => t.occupiesColumn(e)));
        ...
        SelectRowModule: class extends M {
            ...
            initializeRow(e) {
                ...
                e.modules.select = {selected: !1}, s.classList.toggle("tabulator-selectable", i), s.classList.toggle("tabulator-unselectable", !i), t.checkRowSelectability(e) && t.table.options.selectableRows && "highlight" != t.table.options.selectableRows && ("click" === t.table.options.selectableRowsRangeMode ? s.addEventListener("click", this.handleComplexRowClick.bind(this, e)) : (s.addEventListener("click", (function (i) {
